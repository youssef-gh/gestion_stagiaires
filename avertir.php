						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<table id="zctb" class=" table table-striped table-bordered " cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT * from  demandeliste  JOIN stage on stage.num = demandeliste.stage_id where afficher = 1 ORDER by id DESC";
										$query = $pdo -> prepare($sql);
										$query->execute();
										...
										<tr>
											...
											<td style = "color : yellow;"><b> Refusé !</td>
											<?php } 
											if ($result->refuser == 0) {?>
											<td style = "color : yellow;"><b> Confirmer !</td> 
											<?php }
											if($result->refuser == 3){?>
											<td style = "color : yellow;"><b> Pas encore !</td> <?php }?>
											...
											<td><a href="information.php?num=<?php echo $result->info;?>">Informations sur stage</a>
											<td><a href="dem_refuser.php?aid=<?php echo $result->num;?>">CANCEL</a>
