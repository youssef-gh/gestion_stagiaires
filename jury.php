...
header('location:index.php');
    ...
    if(isset($_POST['submit'])) {
        echo "<script type='text/javascript'>alert('sdqsdqs');</script>";
 ...
 echo "Problem uploading file";
        ...
        $sql="INSERT INTO upload value :pdf";
        $query = $pdo->prepare($sql);
								...
								<table id="zctb" class=" table table-striped table-bordered " cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT * from  stage join etudiant on etudiant.cne = stage.cne_etudiant where id_encadrant = '$id_enc' ";
										...
										<tr>
                                            ...
                                            <?php if(isset($_REQUEST['cne'])) { ?>
                                                <form action="upload.php?cne=<?php echo $result->cne;?>" method="get" id="form1">


                                                <td><input type="file" name="attestation" required>
                                                <button class=" btn-primary" form = "form1" name="submit" type="submit">Save changes</button></td>
                                                </form><?php }?>
