...
$duree=$_POST['duree'];
$info=$_POST['info'];
$sql = "insert into stage(ville, entreprise,domaine, encadrant, info, duree, type) values(:ville, :entreprise, :domaine, :encadrant,:info, :duree, :type)";
...
$query->bindParam(':encadrant',$encadrant,PDO::PARAM_STR);
...
<label class="col-sm-2 control-label" style = "padding-right: 60px;"> entreprise <span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="entreprise" class="form-control"  style = "margin-left:-20px" required>
</div>
<div class="form-group">
...
<div class="form-group">
<label class="col-sm-2 control-label" style = "padding-right: 40px;"> encadrant <span style="color:red">*</span></label>
<div class="col-sm-4">
